...
To install Matchtools using pip do
...
modules in the library is at: http://matchtools.readthedocs.io/en/latest/.
...
To test that Matchtools is working correctly, you can run the script
...
matchtools (directory) -- Contains the code of library itself:
|
...
|-- extras_example.py    An example with more complexity, making
			 ...
			 and the matchtools.extras subpackage.
